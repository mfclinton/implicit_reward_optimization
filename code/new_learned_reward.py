...
def Run_Gridworld_Implicit(T1, T2, T3, approximate, reuse_trajectories):
    ...
    result_path =  str(os.getcwd()) + "/saved/reward_{0}_{1}_{2}_({3},{4},{5})_{6}_{7}{8}/".format(actual_reward_over_time[-1].item(), approximate, reuse_trajectories, T1, T2, T3, c_word_str, using_prior_str, prior_id)
