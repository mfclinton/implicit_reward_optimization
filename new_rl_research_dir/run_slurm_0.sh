...
python -m Src.run -cn config_GW seed=$SLURM_ARRAY_TASK_ID num_runs=1 config.name=regular_method config.env.aux_r_id=0 config.T1=40 config.T2=100 config.T3=25 config.batch_size=200
